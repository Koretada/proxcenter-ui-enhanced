...
/* ------------------------------------------------------------------ */
/* Network detail panels (Connection / Node / VLAN)                   */
/* ------------------------------------------------------------------ */
...
function NetworkDetailPanel({ selection, onSelect }: {
...
/* ------------------------------------------------------------------ */
/* Storage intermediate panels (Cluster / Node)                       */
/* ------------------------------------------------------------------ */

function StorageIntermediatePanel({ selection, clusterStorages, onSelect }: {
  selection: InventorySelection
